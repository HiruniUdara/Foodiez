...
- **SVG Icons**: Scalable and lightweight icons for UI elements.
...
Foodiez/
│
├── index.html        — Home page with hero carousel and featured food
├── about.html        — Information about the Foodiez platform
...
*Since this is a front-end web application, no server or database setup is required.*
...
- 🎓 University students
- 🧑‍💼 Office workers
- ⏱ Busy individuals who prefer ordering food online
- 🍽 Small restaurants and food businesses

The goal is to create a simple, fast, and user-friendly food ordering interface.

## 🚀 Future Improvements

Planned improvements for the next phase include:
- User authentication system (Back-end)
